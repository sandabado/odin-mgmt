...
import { CampaignCreateModal, CampaignPressDesk, type CampaignContactOption } from "@/components/admin/CampaignForms";
...
export default async function CampaignsPage({ searchParams }: { searchParams: Promise<{ artist?: string; type?: string; status?: string }> }) {
  ...
  const [{ data: campaignData }, { data: artistData }, { data: projectData }, { data: confirmedDealData }, { data: contactData }] = await Promise.all([
