...
import { OperationsDashboard, type DashboardActivity, type DashboardArm, type DashboardCard, type DashboardCountdown, type DashboardLiveItem, type DashboardQuickLink } from "@/components/admin/OperationsDashboard";
...
export default async function AdminDashboardPage() {
  ...
  const activity: DashboardActivity[] = [
    ...
    ...practices.map((practice): DashboardActivity => ({ id: `practice-${practice.id}`, description: `Practice scheduled: ${practice.title}`, createdAt: practice.created_at, href: "/admin/calendar", tone: "ghost" })),
    ...meetings.map((meeting): DashboardActivity => ({ id: `meeting-${meeting.id}`, description: `Meeting scheduled: ${meeting.title}`, createdAt: meeting.created_at, href: "/admin/calendar", tone: "ghost" })),
  ...
  const quickLinks: DashboardQuickLink[] = [
    ...
    { id: "upcoming", label: "upcoming", count: String(upcomingPractices.length + upcomingMeetings.length + upcomingDeals.length), context: "next 7 days", href: "/admin/calendar", icon: "upcoming" },
