...
export default async function ArtistsPage({ searchParams }: { searchParams: Promise<{ market?: string }> }) {
  ...
  const query = supabase.from("artists").select("id, profile_id, artist_name, photo_url, genres, draw_size, home_market, status").order("artist_name");
